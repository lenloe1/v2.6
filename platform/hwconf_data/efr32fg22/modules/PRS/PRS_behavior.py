...
PRS_SOURCE_TO_SIGNALS_MAP = {
    ...
    'TEAL': ['TEAL_CTIOUT0', 'TEAL_CTIOUT1', 'TEAL_CTIOUT2', 'TEAL_CTIOUT3', ],
    ...
    'PDML': ['PDML_PDMDSRPULSE', 'PDML_PDMDBG0', 'PDML_PDMDBG1', 'PDML_PDMDBG2', 'PDML_PDMDBG3', 'PDML_PDMDBG4', 'PDML_PDMDBG5', 'PDML_PDMDBG6', ],
    'PDM': ['PDM_PDMDBG7', ],
    ...
    'RFSENSE': ['RFSENSE_BYTEDET', 'RFSENSE_CALRUNNING', 'RFSENSE_FIRSTTRIP', 'RFSENSE_PREDET', 'RFSENSE_RFDATA', 'RFSENSE_SYNCDET', ],
}
