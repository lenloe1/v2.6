...
# get module mapping
from efr32mg22.modules.PIN.PIN_Class import *
...
from efr32mg22.PythonSnippet.CodeGen import *
from efr32mg22.PythonSnippet.StudioProject import *
...
def generate(context):
    ...
    for transition in modeTransitions():
        ...
        familyobj = dep.Family('efr32mg22')
        ...
        mod_inst = EUART_behavior.EUART('EUART0')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
        ...
        mod_inst = IADC_behavior.IADC('IADC0')
        mod_inst.load_halconfig_model(available_modules, familyobj)
        module_list.append(mod_inst)
